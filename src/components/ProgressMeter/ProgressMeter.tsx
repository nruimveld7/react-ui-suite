...
export function Progress({
  ...
  return (
    <div className={clsx("rui-progress-meter__u-style--5a2508227c rui-root", className)}>
      {label ? (
      ...
      {description ? (
        <p className="rui-progress-meter__u-font-size-11px--d058ca6de6 rui-progress-meter__u-rui-text-opacity-1--30426eb75c rui-progress-meter__u-rui-text-opacity-1--6462b86910 rui-text-wrap">{description}</p>
      ) : null}
