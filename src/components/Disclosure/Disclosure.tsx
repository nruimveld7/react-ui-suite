    ...
    >
      ...
      >
        <span className="rui-disclosure__u-display-flex--60fbb77139 rui-disclosure__u-flex-1-1-0--36e579c0b4 rui-disclosure__u-align-items-center--3960ffc248 rui-disclosure__u-gap-0-5rem--77a2a20e90">
          <span className="rui-disclosure__title rui-text-wrap rui-disclosure__u-border-radius-0-5rem--5f22e64f22 rui-disclosure__u-background-color-rgb-241-245-249--34d54ab9e5 rui-disclosure__u-padding-left-0-5rem--d5eab218aa rui-disclosure__u-padding-top-0-25rem--660d2effb8 rui-disclosure__u-font-size-11px--d058ca6de6 rui-disclosure__u-font-weight-600--e83a7042bc rui-disclosure__u-text-transform-uppercase--117ec720ea rui-disclosure__u-letter-spacing-0-2em--2da1a7016e rui-disclosure__u-color-rgb-100-116-139-1--30426eb75c rui-disclosure__u-box-shadow-0-0-0000-0-0-0000-ins--eca5782b24 rui-disclosure__u-background-color-rgb-39-39-42-0---b37a7836e7 rui-disclosure__u-color-rgb-212-212-216-1--5b8efd1d78">
            {title}
          </span>
        </span>
        <span
      ...
      <div className="rui-disclosure__content rui-text-wrap rui-disclosure__u-margin-top-0-75rem--eccd13ef4f rui-disclosure__u-style--6f7e013d64 rui-disclosure__u-font-size-0-875rem--fc7473ca09 rui-disclosure__u-color-rgb-71-85-105-1--2d6fbf48fa rui-disclosure__u-color-rgb-212-212-216-1--5b8efd1d78">
        {children}
      </div>
    </details>
  );
